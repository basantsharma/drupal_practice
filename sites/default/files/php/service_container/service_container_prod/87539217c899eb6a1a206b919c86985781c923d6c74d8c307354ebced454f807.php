...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'access_check.switch_user' => 'getAccessCheck_SwitchUserService',
            ...
            'devel.event_subscriber' => 'getDevel_EventSubscriberService',
            'devel.route_subscriber' => 'getDevel_RouteSubscriberService',
            ...
            'kint.twig.kint_extension' => 'getKint_Twig_KintExtensionService',
            ...
            'plugin.manager.develgenerate' => 'getPlugin_Manager_DevelgenerateService',
    ...
    /**
     * Gets the 'access_check.switch_user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\devel\Access\SwitchAccess A Drupal\devel\Access\SwitchAccess instance.
     */
    protected function getAccessCheck_SwitchUserService()
    {
        $this->services['access_check.switch_user'] = $instance = new \Drupal\devel\Access\SwitchAccess($this->get('csrf_token'));

        $instance->_serviceId = 'access_check.switch_user';
    ...
    /**
     * Gets the 'devel.event_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\devel\EventSubscriber\DevelEventSubscriber A Drupal\devel\EventSubscriber\DevelEventSubscriber instance.
     */
    protected function getDevel_EventSubscriberService()
    {
        $this->services['devel.event_subscriber'] = $instance = new \Drupal\devel\EventSubscriber\DevelEventSubscriber($this->get('config.factory'), $this->get('current_user'), $this->get('module_handler'), $this->get('url_generator'));

        $instance->_serviceId = 'devel.event_subscriber';

        return $instance;
    }

    /**
     * Gets the 'devel.route_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\devel\Routing\RouteSubscriber A Drupal\devel\Routing\RouteSubscriber instance.
     */
    protected function getDevel_RouteSubscriberService()
    {
        $this->services['devel.route_subscriber'] = $instance = new \Drupal\devel\Routing\RouteSubscriber($this->get('entity.manager'));

        $instance->_serviceId = 'devel.route_subscriber';
    ...
    /**
     * Gets the 'kint.twig.kint_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\kint\Twig\KintExtension A Drupal\kint\Twig\KintExtension instance.
     */
    protected function getKint_Twig_KintExtensionService()
    {
        $this->services['kint.twig.kint_extension'] = $instance = new \Drupal\kint\Twig\KintExtension();

        $instance->_serviceId = 'kint.twig.kint_extension';
    ...
    {
        $this->services['module_handler'] = $instance = new \Drupal\Core\Extension\ModuleHandler($this->get('app.root'), array('block' => array('type' => 'module', 'pathname' => 'core/modules/block/block.info.yml', 'filename' => 'block.module'), 'breakpoint' => array('type' => 'module', 'pathname' => 'core/modules/breakpoint/breakpoint.info.yml', 'filename' => 'breakpoint.module'), 'config' => array('type' => 'module', 'pathname' => 'core/modules/config/config.info.yml', 'filename' => 'config.module'), 'dblog' => array('type' => 'module', 'pathname' => 'core/modules/dblog/dblog.info.yml', 'filename' => 'dblog.module'), 'devel' => array('type' => 'module', 'pathname' => 'modules/devel/devel.info.yml', 'filename' => 'devel.module'), 'devel_generate' => array('type' => 'module', 'pathname' => 'modules/devel/devel_generate/devel_generate.info.yml', 'filename' => 'devel_generate.module'), 'drupalers' => array('type' => 'module', 'pathname' => 'modules/drupalers/drupalers.info.yml', 'filename' => NULL), 'entity_reference' => array('type' => 'module', 'pathname' => 'core/modules/entity_reference/entity_reference.info.yml', 'filename' => 'entity_reference.module'), 'field' => array('type' => 'module', 'pathname' => 'core/modules/field/field.info.yml', 'filename' => 'field.module'), 'field_ui' => array('type' => 'module', 'pathname' => 'core/modules/field_ui/field_ui.info.yml', 'filename' => 'field_ui.module'), 'file' => array('type' => 'module', 'pathname' => 'core/modules/file/file.info.yml', 'filename' => 'file.module'), 'filter' => array('type' => 'module', 'pathname' => 'core/modules/filter/filter.info.yml', 'filename' => 'filter.module'), 'kint' => array('type' => 'module', 'pathname' => 'modules/devel/kint/kint.info.yml', 'filename' => 'kint.module'), 'link' => array('type' => 'module', 'pathname' => 'core/modules/link/link.info.yml', 'filename' => 'link.module'), 'movie_song' => array('type' => 'module', 'pathname' => 'modules/movie_song/movie_song.info.yml', 'filename' => NULL), 'node' => array('type' => 'module', 'pathname' => 'core/modules/node/node.info.yml', 'filename' => 'node.module'), 'options' => array('type' => 'module', 'pathname' => 'core/modules/options/options.info.yml', 'filename' => 'options.module'), 'page_cache' => array('type' => 'module', 'pathname' => 'core/modules/page_cache/page_cache.info.yml', 'filename' => 'page_cache.module'), 'system' => array('type' => 'module', 'pathname' => 'core/modules/system/system.info.yml', 'filename' => 'system.module'), 'text' => array('type' => 'module', 'pathname' => 'core/modules/text/text.info.yml', 'filename' => 'text.module'), 'toolbar' => array('type' => 'module', 'pathname' => 'core/modules/toolbar/toolbar.info.yml', 'filename' => 'toolbar.module'), 'update' => array('type' => 'module', 'pathname' => 'core/modules/update/update.info.yml', 'filename' => 'update.module'), 'user' => array('type' => 'module', 'pathname' => 'core/modules/user/user.info.yml', 'filename' => 'user.module'), 'views' => array('type' => 'module', 'pathname' => 'core/modules/views/views.info.yml', 'filename' => 'views.module'), 'views_ui' => array('type' => 'module', 'pathname' => 'core/modules/views_ui/views_ui.info.yml', 'filename' => 'views_ui.module'), 'minimal' => array('type' => 'profile', 'pathname' => 'core/profiles/minimal/minimal.info.yml', 'filename' => 'minimal.profile')), $this->get('cache.bootstrap'));
    ...
    public function getPlugin_CacheClearerService($lazyLoad = true)
    {
        ...
        $instance->addCachedDiscovery($this->get('plugin.manager.develgenerate'));
    ...
    /**
     * Gets the 'plugin.manager.develgenerate' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\devel_generate\DevelGeneratePluginManager A Drupal\devel_generate\DevelGeneratePluginManager instance.
     */
    protected function getPlugin_Manager_DevelgenerateService()
    {
        $this->services['plugin.manager.develgenerate'] = $instance = new \Drupal\devel_generate\DevelGeneratePluginManager($this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));

        $instance->_serviceId = 'plugin.manager.develgenerate';
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('kint.twig.kint_extension'));
    ...
    protected function getAccessManager_CheckProviderService()
    {
        ...
        $instance->addCheckService('access_check.switch_user', 'access', array(), false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'devel' => array(
                    'type' => 'module',
                    'pathname' => 'modules/devel/devel.info.yml',
                    'filename' => 'devel.module',
                ),
                'devel_generate' => array(
                    'type' => 'module',
                    'pathname' => 'modules/devel/devel_generate/devel_generate.info.yml',
                    'filename' => 'devel_generate.module',
                ),
                'drupalers' => array(
                    'type' => 'module',
                    'pathname' => 'modules/drupalers/drupalers.info.yml',
                    'filename' => NULL,
                ),
                ...
                'kint' => array(
                    'type' => 'module',
                    'pathname' => 'modules/devel/kint/kint.info.yml',
                ...
                'movie_song' => array(
                    'type' => 'module',
                    'pathname' => 'modules/movie_song/movie_song.info.yml',
                    'filename' => NULL,
                ),
                'node' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\devel' => 'modules/devel/src',
                'Drupal\\devel_generate' => 'modules/devel/devel_generate/src',
                'Drupal\\drupalers' => 'modules/drupalers/src',
                ...
                'Drupal\\kint' => 'modules/devel/kint/src',
                'Drupal\\link' => 'core/modules/link/src',
                'Drupal\\movie_song' => 'modules/movie_song/src',
